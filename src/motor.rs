...
impl<'a, Comm: HerkulexCommunication> Motor<'_, Comm> {
    ...
    /// Acceleration is same as deceleration ratio.
    ///
    /// - Maximum value is 50.
    ///
    ...
    pub fn get_saturator_slope(&self) -> u16 {
        ...
        u16::from(ans[9]) | u16::from(ans[10]) << 8
    }
    ...
    /// Get the details of the status error
    ...
    ///
    /// Show velocity measurement, velocity is measured in 11.2ms intervals.
    ...
    /// Get the absolute goal position
    ...
    /// Get the absolute desired trajectory position
